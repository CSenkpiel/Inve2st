...
WHERE 
  ...
  tb_financial_parameter_types.c_financial_parameter_types_description = '{2}' AND 
    ...
    def query_political_incentives(self, c_investment_options_description, c_application_description,
                                   c_political_instrument_scenario, tb_political_instrument_types_description):
        """
        ...
        """
        return """SELECT 
  tb_political_incentives.c_political_incentive_value, 
  tb_political_incentives.c_political_incentive_unit_fk, 
  tb_political_instrument_types.tb_political_instrument_types_description,
tb_application.c_application_description,
tb_political_incentives.c_political_instrument_scenario
FROM 
...
WHERE 
  ...
  tb_political_incentives.c_political_instrument_scenario = '{2}' AND 
  tb_political_instrument_types.tb_political_instrument_types_description = '{3}';""".format(
            c_investment_options_description, c_application_description, c_political_instrument_scenario,
